...
const Discount = () => {
  ...
  return (
    ...
    <div className="bg-white py-10 rounded-xl border">
            ...
            <div>
            <Link to='/discount/createDiscount'><button className='flex m-auto bg-black/75 hover:bg-black text-xs font-bold rounded-lg px-3 py-2 text-white'>Create Discount </button>
            </Link></div>
        </div>
   </section>
  )
